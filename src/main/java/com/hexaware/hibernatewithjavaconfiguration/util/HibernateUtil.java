package com.hexaware.hibernatewithjavaconfiguration.util;
...
import com.hexaware.hibernatewithjavaconfiguration.entity.Seller;
...
public static SessionFactory getSessionFactory() {
		...
		if(sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL,"jdbc:mysql://localhost:3306/hwhibexamples?useSSL=false");
